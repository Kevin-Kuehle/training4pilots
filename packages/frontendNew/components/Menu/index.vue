<template>
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
        ...
        >
            ...
            >
                <ul
                    class="flex flex-col font-medium md:flex-row md:space-x-8 rtl:space-x-reverse"
                >
                    <li>
                        <a
                            href="#"
                            class="block text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
                            aria-current="page"
                            >Home</a
                        >
                    </li>
        ...
        <div
            ...
            class="bg-white border-gray-200 shadow-sm border-y dark:bg-gray-800 dark:border-gray-600"
        >
            <div
                :class="{
                    hidden: !showMenu,
            ...
            >
                ...
                <a
                    ...
                    style="
                        background-image: url(/docs/images/dashboard-overview.png);
                    "
                >
                    <p
